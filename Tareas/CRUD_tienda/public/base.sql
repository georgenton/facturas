...
-- -----------------------------------------------------
-- Table `tienda`.`Unidad_Medida`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tienda`.`Unidad_Medida` (
...
-- Table `tienda`.`IVA`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tienda`.`IVA` (
...
-- Table `tienda`.`Kardex`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `tienda`.`Kardex` (
  ...
  CONSTRAINT `fk_Kardex_Unidad_Medida`
    ...
    REFERENCES `tienda`.`Unidad_Medida` (`idUnidad_Medida`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `tienda`.`Detalle_Factura` (
  ...
  CONSTRAINT `fk_Detalle_Factura_Kardex1`
    ...
    REFERENCES `tienda`.`Kardex` (`idKardex`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
